		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-4 mid-content">
					...
					<router-link :to="{ name: 'Authenticate' }" class="route-link text-left">
						criar conta
					</router-link>
				</div>
				<div class="col-sm-4 right-content">
					...
					<span class="text-left" style="line-height: 1.8">
						...
						gerir o conselho Eco-escolas e á criação de atividades para o plano de ação
						e poderá ter interação com outros utilizadores.
					</span>
				</div>
			</div>
		</div>
