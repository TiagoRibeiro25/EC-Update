<script setup>
import ModalAtaInfo from "@/components/Manage/Meetings/modals/ModalAtaInfo.vue";
import ModalAddAta from "@/components/Manage/Meetings/modals/ModalAddAta.vue";
...
<template>
	...
	<ModalAtaInfo v-if="meeting.ata" :modalId="modalId" :meeting="meeting" />
	<ModalAddAta v-else :modalId="modalId" :meeting="meeting" />
</template>
